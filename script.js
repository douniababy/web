...
const searchSections = [
...

    {
        ...
        entries: {
            "MainCameraTransform":   "Transform MainCameraTransform; // 0x258",
            "Camera":                "protected Camera FCKFGJMEECI; // 0x18",
            "camera up":         "private float PECENLKCBLJ;",
            "camera left":       "private byte GJIDOPDDOCI;",
            "vision+protected":  "private float NAPGJKCEMEL;",
            "FallingSpeedUpScale":   "public float FallingSpeedUpScale; // 0x1CC",
            "RunSpeedUpScale":       "public float RunSpeedUpScale; // 0x1D0",
...

    {
        section: "Ammoinclip",
        entries: {
            "BuffWeaponMoveSpeedScale": "public float BuffWeaponMoveSpeedScale; // 0xCC",
            "BuffWeaponAmmoClip":      "public int BuffWeaponAmmoClip; // 0xD0"
        }
    },
...

    {
        ...
        entries: {
            ...
            "FixedDeltaTime":        "m_FixedDeltaTime; // 0x24"
        }
    },
